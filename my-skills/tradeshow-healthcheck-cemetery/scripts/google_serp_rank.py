...
# variants like "Holy Cross Catholic Cemetery" vs "Holy Cross Cemetery"
# and "Forest Lawn Memorial Park" vs "Forest Lawn" resolve correctly in
# both the local-pack matcher and the Google Ads matcher.
